...
class Training_Dataset_Maker(Dataset):
    ...
    def __init__(self, training_data):
        ...
        #self.custom_training_dataset_from_csv = np.array(pd.read_csv(path_to_training_dataset, header=None))
        self.custom_training_dataset = training_data
        print("Shape of the training data set sent to the data loader is: ",self.custom_training_dataset.shape) #1068288, 101)
        self.time_sequence_length = 100


        print("Total samples in the training data set is: ", len(self.custom_training_dataset)) #1068288


    def __len__(self):


        return len(self.custom_training_dataset)
    ...
    def __getitem__(self, idx):
        ...
        features = self.custom_training_dataset[idx][:self.time_sequence_length]


        label = self.custom_training_dataset[idx][self.time_sequence_length]
